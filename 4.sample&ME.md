...
​	令<a href="https://www.codecogs.com/eqnedit.php?latex=u_1,....,u_k" target="_blank"><img src="https://latex.codecogs.com/gif.latex?u_1,....,u_k" title="u_1,....,u_k" /></a>,服从均匀分布，让<a href="https://www.codecogs.com/eqnedit.php?latex=x_1&space;=&space;F^{-1}&space;(u_1),x_k=&space;F^{-1}(u_k)" target="_blank"><img src="https://latex.codecogs.com/gif.latex?x_1&space;=&space;F^{-1}&space;(u_1),x_k=&space;F^{-1}(u_k)" title="x_1 = F^{-1} (u_1),x_k= F^{-1}(u_k)" /></a>，那么<a href="https://www.codecogs.com/eqnedit.php?latex=x_i" target="_blank"><img src="https://latex.codecogs.com/gif.latex?x_i" title="x_i" /></a> 服从分布F。
~~~SCALA
//指数分布随机数
