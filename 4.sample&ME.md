...
​	令<a href="https://www.codecogs.com/eqnedit.php?latex=u_1,....,u_k" target="_blank"><img src="https://latex.codecogs.com/gif.latex?u_1,....,u_k" title="u_1,....,u_k" /></a>,服从均匀分布，让x~1~ = $F^{-1}$ (u~1~),x~k~ = $F^{-1}$ (u~k~)，那么x~i~ 服从分布F。
~~~SCALA
//指数分布随机数
